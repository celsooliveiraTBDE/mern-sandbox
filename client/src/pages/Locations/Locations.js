                    ...
                    {this.state.recipes.map((recipe, index) => {
                      return (
                        ...
                        <Row size="xs-12">
                          ...
                          {/* <Button color="secondary" block="true"onClick={() => this.savemyArticle({ index })} active={this.state.isToggleOn.includes({ index })}>SAVE</Button> */}
                          <Button color="danger" block="true"onClick={() => this.removemyArticle({ index })} active={this.state.isToggleOn.includes({ index })}>REMOVE</Button>
